...
package edu.iit.workload.network;
...
/**
 * A simple example showing how to create a datacenter with one host and a network
 * topology and and run one cloudlet on it. Here, instead of using a BRIE file describing
