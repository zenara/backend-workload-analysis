...
/**
 * A simple example showing how to create two datacenters with one host each and run
...
public class NetworkExample3 {
	...
	private static Datacenter createDatacenter(String name) {
		...
		// only one VM
		// is allowed to run on each Pe. As each Host has only one Pe, only one VM can run
		// on each Host.
