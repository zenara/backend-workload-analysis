...
public abstract class RunnerAbstract {
	...
	public void run(boolean enableOutput, boolean outputToFile, String inputFolder, String outputFolder,
			ExecutableData executableData, String uuid) {
		try {
			initLogOutput(enableOutput, outputToFile, outputFolder, executableData.getWorkload(),
		...
		start(getExperimentName(executableData.getWorkload(), executableData.getVmAllocationPolicy(),
				executableData.getVmSelectionPolicy(), executableData.getParameter()), outputFolder,
	...
	protected VmAllocationPolicy getVmAllocationPolicy(String vmAllocationPolicyName, String vmSelectionPolicyName,
		...
		if (vmAllocationPolicyName.equals("iqr")) {
			...
			vmAllocationPolicy = new PowerVmAllocationPolicyMigrationGA(hostList, vmSelectionPolicy);
		}
		else {
