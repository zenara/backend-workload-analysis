...
public class Constants {
	...
	/*
	 * VM instance types: High-Memory Extra Large Instance: 3.25 EC2 Compute Units, 8.55
	 * GB // too much MIPS High-CPU Medium Instance: 2.5 EC2 Compute Units, 0.85 GB Extra
	 * Large Instance: 2 EC2 Compute Units, 3.75 GB Small Instance: 1 EC2 Compute Unit,
	 * 1.7 GB Micro Instance: 0.5 EC2 Compute Unit, 0.633 GB We decrease the memory size
	 * two times to enable oversubscription
	 *
	 */
	 ...
	 * ProLiant ML110 G5 (1 x [Xeon 3075 2660 MHz, 2 cores], 4GB) We increase the memory
	 * size to enable over-subscription (x4)
	 */
