 ...
 * @author Amin
 */
public abstract class PowerVmAllocationPolicyMigrationAbstractVmPlacementFFT
		extends PowerVmAllocationPolicyMigrationAbstract {

	public PowerVmAllocationPolicyMigrationAbstractVmPlacementFFT(List<? extends Host> hostList,
