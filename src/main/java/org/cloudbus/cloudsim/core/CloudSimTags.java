...
/**
 * Contains various static command tags that indicate a type of action that needs to be
 * undertaken by CloudSim entities when they receive or send events. <b>NOTE:</b> To avoid
 * conflicts with other tags, CloudSim reserves negative numbers, 0 - 299, and 9600.
 *
...
public class CloudSimTags {
	...
	/**
	 * Denotes insignificant simulation entity or time. This tag will not be used for
	 ...
	 * This tag is normally used between CloudInformationService and CloudResouce entity.
	 */
	public static final int REGISTER_RESOURCE_AR = BASE + 3;

	/**
	 * Denotes a list of all hostList, including the ones that can support advance
	 * reservation. This tag is normally used between CloudInformationService and CloudSim
	 * entity.
	 */
	public static final int RESOURCE_LIST = BASE + 4;

	/**
	 * Denotes a list of hostList that only support advance reservation. This tag is
	 * normally used between CloudInformationService and CloudSim entity.
	 */
	public static final int RESOURCE_AR_LIST = BASE + 5;

	/**
	 * Denotes grid resource characteristics information. This tag is normally used
	 * between CloudSim and CloudResource entity.
	 */
	public static final int RESOURCE_CHARACTERISTICS = BASE + 6;

	/**
	 * Denotes grid resource allocation policy. This tag is normally used between CloudSim
	 * and CloudResource entity.
	 */
	public static final int RESOURCE_DYNAMICS = BASE + 7;

	/**
	 * Denotes a request to get the total number of Processing Elements (PEs) of a
	 * resource. This tag is normally used between CloudSim and CloudResource entity.
	 */
	public static final int RESOURCE_NUM_PE = BASE + 8;

	/**
	 * Denotes a request to get the total number of free Processing Elements (PEs) of a
	 * resource. This tag is normally used between CloudSim and CloudResource entity.
	 */
	public static final int RESOURCE_NUM_FREE_PE = BASE + 9;

	/**
	 * Denotes a request to record events for statistical purposes. This tag is normally
	 * used between CloudSim and CloudStatistics entity.
	 */
	...
	/**
	 * Denotes a request to send an Accumulator object based on category into an event
	 * scheduler. This tag is normally used between ReportWriter and CloudStatistics
	 * entity.
	 */
	...
	/**
	 * Denotes a request to get a list of other regional GIS entities from the system GIS
	 * entity
	 */
	public static final int REQUEST_REGIONAL_GIS = BASE + 14;

	/**
	 * Denotes request for grid resource characteristics information. This tag is normally
	...
	/**
	 * Denotes the return of a Cloudlet back to sender. This tag is normally used by
	 * CloudResource entity.
	 */
	public static final int CLOUDLET_RETURN = BASE + 20;

	/**
	 * Denotes the submission of a Cloudlet. This tag is normally used between CloudSim
	 * User and CloudResource entity.
	 */
	public static final int CLOUDLET_SUBMIT = BASE + 21;

	/**
	 * Denotes the submission of a Cloudlet with an acknowledgement. This tag is normally
	...
	/**
	 * Denotes a request to migrate a new VM in a Datacentre With acknowledgement
	 * information sent by the Datacentre
	 */
