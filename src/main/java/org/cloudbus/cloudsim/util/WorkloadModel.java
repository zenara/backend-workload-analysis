...
/**
 * This interface defines what a workload model should provide. A workload model generates
 * a list of jobs that can be dispatched to a resource by {@link Workload}.
 *
